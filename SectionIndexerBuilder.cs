...
namespace Tester.Helpers
{
    public static class SectionIndexerBuilder
    {
        ...
        public static Java.Lang.Object[] BuildSectionHeaders(List<Guest> data)
        {
            ...
            {
                var letter = item.FirstName[0].ToString();
        ...
        public static Dictionary<int, int> BuildSectionForPositionMap(List<Guest> instructors)
        {
            ...
            {
                var letter = instructors[i].FirstName[0].ToString();
        ...
        public static Dictionary<int, int> BuildPositionForSectionMap(List<Guest> instructors)
        {
            var results = new Dictionary<int, int>();
            var used = new SortedSet<string>();
            int section = -1;
